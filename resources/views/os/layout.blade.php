      ...
      <ul id="nav-mobile" class="right">
        <li>
          <a href="" class="dropdown-trigger" data-target='dropdown2'>
            Olá {{ Str::limit(auth()->user()->NOMFUN, 10) }} <i class="material-icons right">expand_more</i>
          </a>
        </li>
      </ul>
    @else
      ...
      <ul id="slide-out" class="sidenav">
        <li>
            <div class="user-view">
                ...
                <a href="#name"><span class="white-text name"> {{auth()->user()->NOMFUN }} </span></a>
        ...
        <li><a href="{{route('admin.create.form')}}"><i class="material-icons">person_add</i>Criar Administrador</a></li>
        @endif
